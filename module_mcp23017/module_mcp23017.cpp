...
// Version      : 1.0.0
// Last-Updated : Sun Jun 22 11:44:35 2014 (7200 CEST)
//           By : Christophe Burki
//     Update # : 517
// URL          : 
// Keywords     : 
 ...
 */
int gnublin_module_mcp23017::init(unsigned char value) {

    value |= CONF_SEQOP;  /* Always enable seq mode. */

    if (_i2c.send(IOCON, &value, 1) < 0) {
        _errorFlag = true;
 ...
 */
const char* gnublin_module_mcp23017::getErrorMessage(void) {
 ...
 */
bool gnublin_module_mcp23017::fail(void) {
 ...
 */
void gnublin_module_mcp23017::setAddress(int address) {
 ...
 */
void gnublin_module_mcp23017::setDevicefile(std::string filename) {
 ...
 */
int gnublin_module_mcp23017::pinMode(int pin, std::string direction) {
    ...
    if (pin < 0 || pin > 15) {
        _errorFlag = true;
        _errorMessage = "Pin number is not between 0 and 15\n";
        return -1;
    }
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::portMode(int port, std::string direction) {
    ...
    if (port < 0 || port > 1) {
        _errorFlag = true;
        _errorMessage = "Port number is not between 0 and 1\n";
        return -1;
    }
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::digitalWrite(int pin, int value) {
 ...
 */
int gnublin_module_mcp23017::digitalRead(int pin) {
 ...
 */
int gnublin_module_mcp23017::readState(int pin) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::writePort(int port, unsigned char value) {
 ...
 */
unsigned char gnublin_module_mcp23017::readPort(int port) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::pinIntMode(int pin, std::string mode) {
    ...
    if (pin >= 0 && pin <= 7) {  /* Port A */
        registerIntEn = GPINTENA;
        registerDefVal = DEFVALA;
        registerIntCon = INTCONA;
        txIntEnBuf[0] = 1 << pin;
        txDefValBuf[0] = 1 << pin;
        txIntConBuf[0] = 1 << pin;
    }
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::portIntMode(int port, std::string mode) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::pinPullUpMode(int pin, int value) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::portPullUpMode(int port, int value) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::pinPolarityMode(int pin, int value) {
 ...
 * @return -1 on error and 1 on success.
 */
int gnublin_module_mcp23017::portPolarityMode(int port, int value) {
 ...
 * @return The value read from the pin.
 */
int gnublin_module_mcp23017::digitalIntRead(int pin) {
 ...
 */
unsigned char gnublin_module_mcp23017::readIntPort(int port) {
 ...
 */
unsigned char gnublin_module_mcp23017::readIntFlagPort(int port) {
 ...
 */
int gnublin_module_mcp23017::pollInt(void) {
 ...
 */
int gnublin_module_mcp23017::intIsr(void (*isr)(int, int, int)) {
 ...
 * isr(int value)
 */
int gnublin_module_mcp23017::pinIntIsr(int pin, void (*isr)(int)) {
 ...
 */
int gnublin_module_mcp23017::portIntIsr(int port, void (*isr)(int, int)) {
